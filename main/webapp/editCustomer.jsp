    			 ...
    			 --%>
							...
							<form action="updateCustomer" method="post"
								...
								<div class="row">
									...
									<div class="col-md-6 mb-2">
										<label class="form-label">Contact Number:</label> <input
											class="form-control" type="text" name="contact_no"
								...
								<div class="row">
									...
									<div class="col-md-6 mb-2">
										...
										<label class="form-label">Gender: </label> <select
											...
											<option value="Other"
												<%=rs.getString("gender").equals("Other") ? "selected" : ""%>>Other</option>
								...
								<div class="row d-flex justify-content-center gap-3 ">
									...
									<a href="editCustomer.jsp?id=<%=id%>"
										class="col col-4 btn btn-danger">Cancel</a>
									<button type="submit" class="col col-4 btn btn-success">Update
										Purchase</button>
									<a href="view_customers.jsp" class="col col-4 btn btn-primary">Show
										Customer List</a>
