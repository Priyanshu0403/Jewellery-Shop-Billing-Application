		...
		<div class="container-fluid"
			...
			<div class="row">
				...
				<div
					...
					<h3 class="mb-1 text-center">Add Customer Info</h3>
					<br>
					<p>Instructions:
					<p>
						step 1: Fill Customer details (submit the details) <br> step
						2 : Add Customer purchase details
					</p>
					<br>
					<h4>Step 1</h4>
					<div class="content ">
						<div class="container ">
							<form action="addCustomerDetails" method="post"
								...
								<!-- action = "addCustomerPurchase" -->
								<div class="row">
									<div class="col-md-6 mb-2">
										<label class="form-label">Name<span>*</span></label> <input type="text"
											class="form-control" name="name" required>
									</div>

									<div class="col-md-6 mb-2 ">
										<label class="form-label">Contact Number<span>*</span></label> <input
									...
									<div class="col-md-6 mb-3">
										<label for="entryGender" class="form-label">Gender<span>*</span> </label> <select
											class="form-select" name="gender" data-bs-toggle="dropdown"
											id="entryGender" required>
								...
								<div class="row">
									...
									<div class="col-md-6 mb-2">
										<label class="form-label">Weight (in grams)</label> <input
											type="number" step="0.01" class="form-control" name="weight"
											required>
									</div>
