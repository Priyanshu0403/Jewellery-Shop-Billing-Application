 ...
 * 
 * import com.ba.dao.connectDB; import com.ba.model.customerInfo;
 * 
 ...
 * 
 * @WebServlet("/displayList") public class displayList extends HttpServlet {
 * 
 * @Override protected void doGet(HttpServletRequest req, HttpServletResponse
 * resp) throws ServletException, IOException { List<customerInfo> c1 = new
 * ArrayList<customerInfo>();
 * 
 * try { Connection conn = connectDB.getConnection(); PreparedStatement ps2 =
 * conn.prepareStatement("Select * FROM customer_purchase_backup");
 * 
 * ResultSet rs = ps2.executeQuery();
 * 
 * while (rs.next()) { customerInfo cstInfo = new customerInfo();
 ...
 * }
 * 
 * HttpSession sess= req.getSession(); sess.setAttribute("cst_list", c1); //here
 * an id cst_list is created which is used in the // customerPurchase.jsp page
 * for redirecting to that page
 * 
 * RequestDispatcher rd = req.getRequestDispatcher("/customerPurchase.jsp");
 * 
 * rd.forward(req, resp); } catch (Exception e) { // TODO: handle exception }
 * 
 * 
 * } }
 * 
