    ...
    <div class="container-fluid mt-1">
     ...
     <!-- mt=margin-top -->
                ...
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-action">Customer Purchases</a>
                    <a href="#" class="list-group-item list-group-item-action">Loans Provided</a>
                    <a href="#" class="list-group-item list-group-item-action">Income & Expenses</a>
                    <a href="#" class="list-group-item list-group-item-action">List of Bills</a>
                    <a href="#" class="list-group-item list-group-item-action">New Loan</a>
                    <a href="#" class="list-group-item list-group-item-action">Generate Invoice</a>
                </div>
