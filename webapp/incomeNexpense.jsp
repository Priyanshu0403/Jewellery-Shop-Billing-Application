...
<body>
 ...
 -->
							<table class="table table-bordered">
								...
								<tbody class="table-secondary" id="tableData">
									...
									<tr>
										...
										<td><a href="editIncomeNExpense?ID=<%=s2.getID()%>"
											class="btn btn-warning btn-sm">Edit <i
												class="fa-solid fa-pen-to-square"></i></a> <a
											href="deleteIncomeNExpense?ID=<%=s2.getID()%>"
						...
						<div class="text-center">
							<a href="addIncomeNExpense.jsp" type="button"
								class="btn btn-primary mb-4">Add New Entry</a>
						</div>
